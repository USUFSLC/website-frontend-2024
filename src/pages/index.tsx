  ...
  return (
    <>
      ...
      <main>
        ...
        <h2>Meetings</h2>
        <p>
          For Fall 2026 we will be holding meetings{" "}
          <strong>every Wednesday</strong> at <strong>6:30 pm</strong> in{" "}
          <strong>EL 109</strong> (check our Discord for more information). See{" "}
          <strong>
